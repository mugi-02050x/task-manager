...
├─────────────────────────────────────────────────┤
│                                                   │
│  ▼ タスクA            [進行中]   1h30m [・・・]  │  ← TaskRow（子あり → タイマーなし）
│    ▼ 子タスクA-1      [未着手]   0h00m [・・・]  │  ← TaskRow（子あり → タイマーなし）
│      子タスクA-1-1    [完了  ] ▶  0h45m [・・・]  │  ← TaskRow（リーフ → タイマーあり）
│    子タスクA-2        [未着手] ▶  0h00m [・・・]  │  ← TaskRow（リーフ → タイマーあり）
│                                                   │
│  タスクB              [未着手] ▶  0h00m [・・・]  │  ← TaskRow（リーフ → タイマーあり）
│                                                   │
